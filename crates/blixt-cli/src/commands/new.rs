...
const LOGO_SVG: &str = r##"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 100">
  <polygon points="26.4,28.4 26.7,12.6 27,0 59.9,0 55.6,6.6 50.9,13.6 42.3,26.4 38.5,30.8 27.1,37.6" fill="#EAA214"/>
  <polygon points="0,56.5 2.1,55.1 6.6,52.3 39.3,32.7 42.3,32.4 64.7,32.4 63,33.7 27.3,54.5 18.1,56.8 16.5,56.8 8.6,56.7" fill="#EAA214"/>
  <polygon points="2.3,52 15.6,23.8 21.9,10.5 24.5,5.2 24.4,21.3 24.2,33.4 23.5,40.1 4,51.5" fill="#EAA214"/>
  <polygon points="24.1,87.3 25.1,84.8 40.7,50.8 44.1,47.1 56.5,39.9 62.2,36.6 57.1,43.9 26,85.1" fill="#EAA214"/>
  <polygon points="15.6,100 15.7,98 23,63.8 24.7,58.1 35.2,52.3 38.3,50.7 37.2,53.4 21.8,86.8" fill="#EAA214"/>
</svg>"##;
